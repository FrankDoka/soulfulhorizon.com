...
export function MobileCTA() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex items-center gap-2 border-t border-[var(--theme-border)] bg-[var(--theme-bg-surface)]/95 px-3 py-2.5 shadow-[0_-2px_10px_rgba(0,0,0,0.05)] backdrop-blur xl:hidden">
      <a
