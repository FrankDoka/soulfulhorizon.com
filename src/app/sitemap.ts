...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/coaching`, lastModified: getFileMtime('src/app/coaching/page.tsx'), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${BASE_URL}/faq`, lastModified: getFileMtime('src/app/faq/page.tsx'), changeFrequency: 'monthly', priority: 0.6 },
